...
class PurchaseOrder(models.Model):
    ...
    def _onchange_partner_id(self):
        values = {}
        values['account_analytic_id'] = self.partner_id.get_account_analytic() or self.env.user.account_analytic_id
        self.update(values)
    ...
    def create(self, vals):
        if not vals.get('account_analytic_id'):
            ...
            if not vals.get('account_analytic_id'):
                vals['account_analytic_id'] = self.env.user.account_analytic_id.id
